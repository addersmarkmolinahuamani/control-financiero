...
def guardar_registro(fila):
    try:
        ...
        st.cache_data.clear() # Limpiamos caché para traer el nuevo registro inmediatamente
        return True
    except Exception as e:
...
if not df.empty and "categoria" in df.columns:
    ...
    # Normalizamos todo a minúscula antes de juntar y luego a capitalizado
...
if not df_filtrado.empty and egresos > 0:
    ...
    st.dataframe(df_mostrar.head(15), use_container_width=True)
else:
